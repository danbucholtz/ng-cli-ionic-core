...
[
  [ "activated", /** state **/ 5 ],
  [ "animated", /** prop mutable **/ 2, /** type boolean **/ 1 ],
  [ "autocomplete", /** prop mutable **/ 2 ],
  [ "autocorrect", /** prop mutable **/ 2 ],
  [ "cancelButtonText", /** prop mutable **/ 2 ],
  [ "debounce", /** prop mutable **/ 2, /** type number **/ 2 ],
  [ "el", /** element ref **/ 7 ],
  [ "focused", /** state **/ 5 ],
  [ "placeholder", /** prop mutable **/ 2 ],
  [ "showCancelButton", /** prop mutable **/ 2, /** type boolean **/ 1 ],
  [ "spellcheck", /** prop mutable **/ 2, /** type boolean **/ 1 ],
  [ "type", /** prop mutable **/ 2 ],
