...
(function (window, document, Context, appNamespace, publicPath) {
    ...
    var INIT_INSTANCE_ERROR = 6;
    var RENDER_ERROR = 7;
    var INITIAL_LOAD_ERROR = 8;
    ...
    function addChildSsrVNodes(domApi, node, parentVNode, ssrVNodeId, checkNestedElements, ssrChildAttrsToRemove, commentsToRemove) {
        ...
        if (checkNestedElements && nodeType === ELEMENT_NODE) {
            ...
            if (childVNodeId) {
                ...
                ssrChildAttrsToRemove.push(node);
            ...
            for (var i = 0; i < node.childNodes.length; i++) {
                addChildSsrVNodes(domApi, node.childNodes[i], parentVNode, ssrVNodeId, checkNestedElements, ssrChildAttrsToRemove, commentsToRemove);
            }
            ...
            if (childVNodeSplt[0] === 's' && childVNodeSplt[1] === ssrVNodeId) {
                ...
                commentsToRemove.push(previousComment, node.nextSibling);
            }
        }
    }
